...
class Program
{
    static void Main(string[] args)
    {
        ...
        Video failVideo = new Video("Best Failed 2026","FailArmy",230);
        ...
        Video MTVChoiceVideo = new Video("MTV Best Choice Award 2009","MTV",120);
        ...
        Video spaceVideo = new Video("How Big is Space","Space Channel",300);
